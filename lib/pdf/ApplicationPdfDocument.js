    ...
    <View style={S.section}>
      <SectionStart title="A.  PERSONAL PARTICULARS">
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={[S.cell, { width: 70, borderLeftWidth: 0, alignItems: 'center', justifyContent: 'center' }]}>
            {d.photo_url
              ? <Image src={d.photo_url} style={{ width: 58, flex: 1 }} />
              : <Text style={{ fontSize: 6, color: '#aaa', textAlign: 'center', transform: 'rotate(-30deg)' }}>Photo not provided</Text>
            }
          </View>
        </View>
      </SectionStart>
