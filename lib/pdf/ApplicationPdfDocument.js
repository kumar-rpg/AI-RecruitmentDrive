    ...
    <View style={S.section}>
      <SectionStart title="A.  PERSONAL PARTICULARS">
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          <View style={[S.cell, { width: 70, borderLeftWidth: 0, alignItems: 'center', paddingTop: 4 }]}>
            <Text style={S.lbl}>Photo</Text>
            {d.photo_url
              ? <Image src={d.photo_url} style={{ width: 58, flex: 1, marginTop: 3 }} />
              : <View style={{ width: 58, flex: 1, borderWidth: 1, borderColor: '#000', marginTop: 3 }} />
            }
          </View>
        </View>
      </SectionStart>
