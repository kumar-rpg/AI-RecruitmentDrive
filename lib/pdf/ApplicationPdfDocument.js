    ...
    <View style={S.section}>
      <SectionStart title="A.  PERSONAL PARTICULARS">
        ...
        <View style={{ flexDirection: 'row' }}>
          ...
          {/* Photo box — stretches to full height of the 3-row left column via flex stretch */}
          <View style={[S.cell, { width: 70, borderLeftWidth: 0, paddingTop: 0, paddingBottom: 0, paddingLeft: 0, paddingRight: 0 }]}>
            {d.photo_url
              ? <Image src={d.photo_url} style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, objectFit: 'cover', objectPosition: 'center top' }} />
              : <Text style={{ fontSize: 6, color: '#bbb', textAlign: 'center', paddingTop: 20 }}>Photo not{'\n'}provided</Text>
            }
          </View>
        </View>
      </SectionStart>
