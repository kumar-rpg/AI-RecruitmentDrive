  ...
  return (
    <View style={S.section}>
      <SectionStart title="A.  PERSONAL PARTICULARS">
        {/* Name/IC row + Gender row on the left; photo box on the right */}
        <View style={{ flexDirection: 'row' }}>
          ...
          {/* Photo — no left border; right border of adjacent cells serves as the divider */}
          <View style={[S.cell, { width: 70, borderLeftWidth: 0, justifyContent: 'flex-start', alignItems: 'center', paddingTop: 4 }]}>
            <Text style={S.lbl}>Photo</Text>
            {d.photo_url
              ? <Image src={d.photo_url} style={{ width: 58, height: 75, objectFit: 'cover', marginTop: 3 }} />
              : <View style={{ width: 58, height: 75, borderWidth: 1, borderColor: '#ccc', marginTop: 3, justifyContent: 'center', alignItems: 'center' }}>
                  <Text style={{ fontSize: 6.5, color: '#aaa' }}>Not provided</Text>
                </View>
            }
          </View>
        </View>
